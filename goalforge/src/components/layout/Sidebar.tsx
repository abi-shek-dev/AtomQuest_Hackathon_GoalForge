      ...
      <div className="flex items-center gap-3 px-4 py-4 border-b border-border h-16">
        ...
        <AnimatePresence>
          {sidebarOpen && (
            ...
            >
              <div className="font-display font-bold text-foreground text-base leading-tight">GoalForge</div>
              <div className="text-xs text-muted-foreground">Performance Portal</div>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
