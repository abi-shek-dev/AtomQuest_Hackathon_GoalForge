...
export const metadata: Metadata = {
  title: {
    default: "GoalForge — Enterprise Performance Management",
    template: "%s | GoalForge",
  },
  description:
    "GoalForge is an AI-inspired enterprise goal setting and performance tracking portal for modern organizations.",
  keywords: ["goal setting", "performance management", "OKR", "HR platform"],
  authors: [{ name: "GoalForge Team" }],
  openGraph: {
    title: "GoalForge — Enterprise Performance Management",
