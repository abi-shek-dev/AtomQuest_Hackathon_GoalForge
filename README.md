# 🎯 GoalForge: Enterprise Performance & Goal Management System

<div align="center">
  <img src="./public/assets/dashboard.png" alt="GoalForge Dashboard" width="100%" />
</div>
...
**GoalForge** is a modern, role-based performance and goal management platform engineered specifically for modern enterprises and built during the **AtomQuest Hackathon**. 

In large organizations, tracking Key Performance Indicators (KPIs), Objectives and Key Results (OKRs), and employee goals is often relegated to disparate spreadsheets, manual email chains, and disconnected HR tools. GoalForge solves this business problem by providing a centralized, transparent, and strictly governed portal for goal lifecycle management. 
